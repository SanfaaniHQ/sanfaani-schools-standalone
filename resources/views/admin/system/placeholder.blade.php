<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">This section follows the current portal mode and license permissions.</p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-lg border border-amber-100 bg-amber-50 p-6 text-sm text-amber-900">
                ...
                <p class="mt-4">Access is controlled by portal mode, license state, feature availability, school context, and user permissions.</p>
            </div>
        </div>
    </div>
</x-app-layout>
