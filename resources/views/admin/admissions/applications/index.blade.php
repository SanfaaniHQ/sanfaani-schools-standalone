<x-app-layout>
    <x-slot name="header"><div><h1 class="text-xl font-semibold">Admission applications</h1><p class="mt-1 text-sm text-gray-500">Only authorized school staff can access this list.</p></div></x-slot>
    <form method="GET" class="mb-5 grid gap-3 rounded-2xl border bg-white p-4 md:grid-cols-5">
    ...
    <div class="overflow-x-auto rounded-2xl border bg-white shadow-sm">
        <table class="min-w-full divide-y">
            ...
            <tbody class="divide-y">
                ...
                @empty<tr><td colspan="6" class="px-5 py-12 text-center text-gray-500">No admission applications match these filters.</td></tr>@endforelse
            </tbody>
        </table>
    </div>
