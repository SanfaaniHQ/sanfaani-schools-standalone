<x-ui.panel>
    <h3 class="text-base font-semibold text-text-primary">Preflight checks</h3>
    @if ($preflight)
    ...
    @else
        <p class="mt-2 text-sm text-text-secondary">No preflight has been run yet. Run preflight before planning any manual update work.</p>
    @endif
</x-ui.panel>
