...
@section('content')
    <div class="space-y-5">
        <div>
            ...
            <p class="mt-2 text-sm text-text-secondary">The single-school installation has been finalized. Installer routes are now blocked by the installation lock.</p>
        </div>
