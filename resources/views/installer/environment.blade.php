...
@section('content')
    <div class="space-y-5">
        <div>
            <h2 class="text-xl font-semibold text-text-primary">Application URL and Environment</h2>
            <p class="mt-2 text-sm text-text-secondary">This step confirms the portal settings saved on the server. Update hosting values through your file manager or hosting control panel if a check needs attention.</p>
        </div>
        ...
        <div class="rounded-md border border-border-subtle bg-bg-secondary p-4 text-sm text-text-secondary">
            ...
            <p class="mt-2">On shared hosting, use cPanel or the hosting file manager for server-controlled settings.</p>
        </div>
