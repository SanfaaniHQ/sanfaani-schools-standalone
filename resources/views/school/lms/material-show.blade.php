    ...
    <div class="space-y-6">
        ...
        <x-ui.panel tone="info" title="Stage 15 Boundary">
            <p class="text-sm leading-6 text-text-secondary">
                This material can be an assignment post, but student submissions and grading require separate setup. Existing CBT items can be linked here without changing CBT attempt or result rules. Live classes use manual meeting links and require internet. Offline LMS, discussions, analytics, video hosting, and payment-gated content are not included here.
            </p>
        </x-ui.panel>
    </div>
</x-app-layout>
