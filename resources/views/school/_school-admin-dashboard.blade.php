@php
    ...
    $moduleCards = [
        ...
        ['title' => 'Staff / Teachers', 'body' => 'Teacher and staff accounts, setup links, active status, and school role assignment.', 'href' => route('school.staff.index'), 'feature' => null],
        ...
        ['title' => 'Result System', 'body' => 'Manual entry, upload, review, publishing, and result settings.', 'href' => route('school.result-system.index'), 'feature' => 'results.manual_entry'],
        ['title' => 'Result Settings / Pass Mark', 'body' => 'Set pass mark, score limits, positions, and publishing requirements.', 'href' => route('school.result-system.index'), 'feature' => 'results.manual_entry'],
        ...
        ['title' => 'Scratch Cards', 'body' => 'Generate Scratch Cards locally, download CSV batches, and track result access.', 'href' => route('school.scratch-cards.index'), 'feature' => null],
        ...
        ['title' => 'Messages', 'body' => 'Direct and selected-recipient conversations within this school.', 'href' => route('portal.conversations.index'), 'feature' => null],
        ['title' => 'School Support Center', 'body' => 'Track internal school support requests, replies, attachments, and assignments.', 'href' => route('school.support.index'), 'feature' => 'support.manage'],
        ['title' => 'Teacher Reviews', 'body' => 'Moderate parent and student feedback for teachers.', 'href' => route('school.teacher-reviews.index'), 'feature' => null],
        ...
        ['title' => 'SMTP Settings', 'body' => 'Configure the school-controlled mail sender and test delivery.', 'href' => route('school.mail-settings.edit'), 'feature' => null],
        ['title' => 'Feature Control', 'body' => 'Enable or disable school features by role for this installation.', 'href' => route('school.feature-control.index'), 'feature' => 'school.features.manage'],
        ['title' => 'Role Permissions', 'body' => 'Review role-level permissions used by this school portal.', 'href' => route('school.role-permissions.index'), 'feature' => 'school.roles.manage'],
