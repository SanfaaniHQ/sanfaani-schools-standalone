    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Update student record for {{ $school->name }}.
            </p>
        </div>
    </x-slot>
                ...
                <form method="POST" action="{{ route('school.students.update', $student) }}" data-loading-text="Updating..." class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="4"
                                  class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900">{{ old('address', $student->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
