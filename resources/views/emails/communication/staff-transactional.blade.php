    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:24px 0;background:#f3f4f6;">
        <tr><td align="center">
            <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:12px;overflow:hidden;">
                <tr><td style="background:#0f766e;color:#ffffff;padding:20px 24px;"><div style="font-size:18px;font-weight:700;">{{ $school?->name ?? ($platformSettings->platform_name ?? 'Sanfaani Schools') }}</div><div style="margin-top:6px;font-size:13px;color:#ccfbf1;">Staff Communication</div></td></tr>
                ...
                <tr><td style="padding:16px 24px;background:#f0fdfa;border-top:1px solid #99f6e4;font-size:12px;color:#134e4a;">{{ $platformSettings->support_email ?? 'support@sanfaani.com' }}</td></tr>
            </table>
        </td></tr>
    </table>
</body>
