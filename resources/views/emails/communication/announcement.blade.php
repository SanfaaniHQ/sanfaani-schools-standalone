    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:24px 0;background:#fff7ed;">
        <tr><td align="center">
            <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:12px;overflow:hidden;">
                <tr><td style="background:#b45309;color:#ffffff;padding:20px 24px;"><div style="font-size:18px;font-weight:700;">{{ $school?->name ?? ($platformSettings->platform_name ?? 'Sanfaani Schools') }}</div><div style="margin-top:6px;font-size:13px;color:#ffedd5;">Important Announcement</div></td></tr>
                ...
                <tr><td style="padding:16px 24px;background:#fffbeb;border-top:1px solid #fed7aa;font-size:12px;color:#9a3412;">{{ $platformSettings->support_email ?? 'support@sanfaani.com' }}</td></tr>
            </table>
        </td></tr>
    </table>
</body>
