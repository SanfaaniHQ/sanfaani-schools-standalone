    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:24px 0;background:#f3f4f6;">
        <tr><td align="center">
            <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:12px;overflow:hidden;">
                <tr><td style="background:#111827;color:#ffffff;padding:20px 24px;"><div style="font-size:18px;font-weight:700;">{{ $platformSettings->platform_name ?? 'Sanfaani Schools' }}</div><div style="margin-top:6px;font-size:13px;color:#d1d5db;">Platform Transactional Message</div></td></tr>
                ...
                <tr><td style="padding:16px 24px;background:#f9fafb;border-top:1px solid #e5e7eb;font-size:12px;color:#6b7280;">{{ $platformSettings->support_email ?? 'support@sanfaani.com' }}</td></tr>
            </table>
        </td></tr>
    </table>
</body>
