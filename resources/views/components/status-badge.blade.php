...
@php
    ...
    $classes = [
        ...
        'repeating' => 'bg-amber-50 text-amber-700 ring-amber-600/20',
        'graduated' => 'bg-emerald-50 text-emerald-700 ring-emerald-600/20',
        'transferred' => 'bg-slate-100 text-slate-700 ring-slate-500/20',
