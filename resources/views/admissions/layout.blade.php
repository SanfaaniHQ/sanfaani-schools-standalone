...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        input, select, textarea { width: 100%; border: 1px solid #cbd5df; border-radius: 10px; background: white; padding: 11px 12px; color: var(--ink); font: inherit; }
        input:focus, select:focus, textarea:focus { border-color: var(--brand); outline: 3px solid rgba(4, 120, 87, .12); }
        .button { display: inline-flex; align-items: center; justify-content: center; border: 0; border-radius: 10px; background: var(--brand); color: white; padding: 12px 18px; font-weight: 800; text-decoration: none; cursor: pointer; }
        .button.secondary { background: #e8f3ef; color: #075e46; }
        .actions { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 24px; }
        .notice { border-radius: 12px; background: #ecfdf3; color: #08643f; padding: 14px 16px; }
        .error { border-radius: 10px; background: #fff1f2; color: #9f1239; padding: 12px 14px; }
        ...
        .token { overflow-wrap: anywhere; border-radius: 10px; background: #172033; color: white; padding: 12px; font-family: ui-monospace, SFMono-Regular, monospace; }
