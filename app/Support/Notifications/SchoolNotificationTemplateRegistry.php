...
class SchoolNotificationTemplateRegistry
{
    public function all(): Collection
    {
        return collect([
            ...
            $this->item('account_created_setup_link', 'Account Created Setup Link', 'Sends a secure password setup link when a portal account is created.', ['school_name', 'recipient_name', 'role', 'login_id', 'setup_url', 'expires_minutes'], 'Set up your {{school_name}} account', SchoolNotificationTemplate::CHANNEL_EMAIL),
            $this->item('account_setup_link_resent', 'Account Setup Link Resent', 'Sends a fresh secure setup link from user account actions.', ['school_name', 'recipient_name', 'role', 'login_id', 'setup_url', 'expires_minutes'], 'Your {{school_name}} setup link', SchoolNotificationTemplate::CHANNEL_EMAIL),
            $this->item('account_disabled', 'Account Disabled', 'Notifies a user when portal access is disabled.', ['school_name', 'recipient_name', 'role'], 'Your {{school_name}} account was disabled', SchoolNotificationTemplate::CHANNEL_EMAIL),
            $this->item('account_enabled', 'Account Enabled', 'Notifies a user when portal access is enabled.', ['school_name', 'recipient_name', 'role', 'login_url'], 'Your {{school_name}} account was enabled', SchoolNotificationTemplate::CHANNEL_EMAIL),
            $this->item('account_archived', 'Account Archived', 'Notifies a user when the account is archived while records are preserved.', ['school_name', 'recipient_name', 'role'], 'Your {{school_name}} account was archived', SchoolNotificationTemplate::CHANNEL_EMAIL),
            $this->item('account_restored', 'Account Restored', 'Notifies a user when an archived account is restored.', ['school_name', 'recipient_name', 'role', 'login_url'], 'Your {{school_name}} account was restored', SchoolNotificationTemplate::CHANNEL_EMAIL),
