...
class SchoolRoleFeatureService
{
    ...
    private const FEATURE_ALIASES = [
        ...
        'communication.results' => 'communication.send',
        'messages' => 'portal.conversations',
        'messages.view' => 'portal.conversations',
        'messages.send' => 'portal.conversations',
        'portal.conversations.index' => 'portal.conversations',
        'portal.conversations.store' => 'portal.conversations',
        'portal.conversations.show' => 'portal.conversations',
        'portal.conversations.messages.store' => 'portal.conversations',
        'teacher_reviews' => 'teacher.reviews',
        'teacher-reviews' => 'teacher.reviews',
        'portal.teacher-reviews.index' => 'teacher.reviews',
        'portal.teacher-reviews.store' => 'teacher.reviews',
        'school.teacher-reviews.index' => 'teacher.reviews',
        'school.teacher-reviews.approve' => 'teacher.reviews',
        'school.teacher-reviews.reject' => 'teacher.reviews',
        'scratch.cards.manage' => 'scratch_cards.manage',
        'scratch-cards.manage' => 'scratch_cards.manage',
        'school.scratch-cards.index' => 'scratch_cards.manage',
        'school.scratch-cards.create' => 'scratch_cards.manage',
        'school.scratch-cards.store' => 'scratch_cards.manage',
        'school.scratch-cards.show' => 'scratch_cards.manage',
        'school.scratch-cards.generate' => 'scratch_cards.manage',
        'school.scratch-cards.download' => 'scratch_cards.manage',
        'school.result-system.index' => 'results.manage',
        'school.result-system.update' => 'results.manage',
        'live_class.view' => 'live_classes.view',
        'live-class.view' => 'live_classes.view',
        'live-classes.view' => 'live_classes.view',
        'school.live-classes.index' => 'live_classes.view',
        'school.live-classes.show' => 'live_classes.view',
        'portal.live-classes.index' => 'live_classes.view',
        'portal.live-classes.show' => 'live_classes.view',
        'live_class.create' => 'live_classes.create',
        'live-class.create' => 'live_classes.create',
        'live-classes.create' => 'live_classes.create',
        'school.live-classes.create' => 'live_classes.create',
        'school.live-classes.store' => 'live_classes.create',
        'live_class.join' => 'live_classes.join',
        'live-class.join' => 'live_classes.join',
        'live-classes.join' => 'live_classes.join',
        'portal.live-classes.join' => 'live_classes.join',
        'live_class.manage' => 'live_classes.manage',
        'live-class.manage' => 'live_classes.manage',
        'live-classes.manage' => 'live_classes.manage',
        'school.live-classes.edit' => 'live_classes.manage',
        'school.live-classes.update' => 'live_classes.manage',
        'school.live-classes.start' => 'live_classes.manage',
        'school.live-classes.complete' => 'live_classes.manage',
        'school.live-classes.cancel' => 'live_classes.manage',
    ];
