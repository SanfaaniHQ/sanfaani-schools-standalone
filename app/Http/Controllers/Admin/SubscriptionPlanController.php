...
class SubscriptionPlanController extends Controller
{
    ...
    public static function featureKeys(): array
    {
        return [
            ...
            'result_access_policy' => 'Result Access Policy',
            ...
            'cbt_exams' => 'CBT Exams',
            'cbt_question_bank' => 'CBT Question Banks',
            'cbt_theory_marking' => 'CBT Theory Marking',
            'cbt_competition_mode' => 'CBT Competition Mode',
            'cbt_certificates' => 'CBT Certificates',
            'cbt_analytics' => 'CBT Analytics',
            'pdf_snapshots' => 'PDF Snapshots',
            'pdf_watermark' => 'PDF Watermark',
            'pdf_qr_verification' => 'PDF QR Verification',
            'sms_units' => 'SMS Units',
