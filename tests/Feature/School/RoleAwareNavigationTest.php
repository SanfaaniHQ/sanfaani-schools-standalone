...
class RoleAwareNavigationTest extends TestCase
{
    ...
    public function test_multi_role_owner_topbar_groups_installation_and_school_workspaces(): void
    {
        ...
        $this->get(route('school.dashboard'))
            ...
            ->assertSee('x-data="workspaceChooser', false)
            ->assertSee('x-teleport="body"', false)
            ->assertSee('data-positioning="centered-modal"', false)
            ->assertSee('workspace-selector-modal', false)
            ->assertSee('data-workspace-modal', false)
            ->assertSee('data-workspace-switch-form', false)
            ->assertSee('data-workspace-options', false)
            ->assertSee('data-workspace-grid', false)
            ->assertSee('lg:grid-cols-3', false)
            ->assertSee('data-workspace-card', false)
            ->assertSee('data-workspace-submit', false)
            ...
            ->assertSee('data-installation-workspace="true"', false)
            ...
            ->assertDontSee('data-positioning="anchored-popover"', false)
            ->assertDontSee('workspace-popover', false)
            ->assertDontSee('workspace-sheet', false)
            ->assertDontSee('data-workspace-mobile-sheet', false)
