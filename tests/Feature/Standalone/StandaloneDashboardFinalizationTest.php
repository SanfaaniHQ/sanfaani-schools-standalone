...
class StandaloneDashboardFinalizationTest extends TestCase
{
    ...
    public function test_owner_dashboard_shows_standalone_health_setup_operations_and_planned_boundaries(): void
    {
        ...
        $this->actingAs($owner)
            ...
            ->assertSee('Online class/subject materials, private resources, and publish workflow are available')
            ...
            ->assertSee('School-scoped CSV exports and preview-first student import tools are available')
