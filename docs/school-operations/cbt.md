...
Live classes are scheduled in the separate manual-link foundation and do not change CBT behavior. Live-class provider abstraction metadata exists outside CBT, while live-class provider APIs, offline LMS, assignment submissions/grading, discussion forums, video hosting, analytics, parent LMS portal, and payment-gated content are outside the CBT integration stage.
