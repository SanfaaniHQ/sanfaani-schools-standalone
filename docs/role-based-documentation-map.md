...
| Sales Team | `marketing/marketing-automation.md`, `demo/demo-automation.md`, `onboarding/guided-onboarding.md` | Use CRM, demo, onboarding, and sales task foundations. |
...
| Marketplace Buyer | `marketplace/marketplace-packaging-plan.md`, `installation/single-school-installer.md` | Packaging is planned, not complete. |
