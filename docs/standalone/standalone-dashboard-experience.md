...
- Reports Pack availability with a link to the school-scoped Reports Center;
- admissions cycles;
- result and report settings;
- CBT setup;
- backup, license, and system-health signals owned by the installation administrator.

Admissions, attendance, fees/finance, results, CBT, scratch cards, communication, reports, promotions, and user management continue to use their existing controllers, routes, services, feature checks, and authorization. The Reports Center links back into detailed module reports and existing CSV exports instead of creating a second reporting system.
